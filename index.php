...
<body>
    ...
    <section id="new-arrivals">
        <div class="container">
            <div class="row mb-5 row-style">
                <div class="col-lg-12">
                    <div class="d-flex gap-3 mt-5 mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="red"
                            class="injected-svg" data-src="/assets/images/icons/new-product-1.svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" role="img">
                            <g clip-path="url(#clip0-76)">
                                <path
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="card-info d-flex flex-column  align-items-center ">
                        ...
                        <h4 class="info">Worldwide Delivery</h4>
                    </div>
                </div>
