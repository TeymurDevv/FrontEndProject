            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="allSideBar mb-3">
                        ...
                        <ul>
                            <li>
                                <div color="warn" value="5" readonly="" class="sc-e02ba328-0 gSOdBv"><svg width="15"
                                        ...
                                        fill="url(#star-0.04046454536049926)" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.8729094346006505)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.9732772316888592)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                    ...
                                    <svgwidth="15" height="15" stroke-width="2" viewBox="0 0 24 24"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.49358670042043573)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                            ...
                            <li>
                                <div color="warn" value="4" readonly="" class="sc-e02ba328-0 gSOdBv"><svg width="15"
                                        height="15" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
                                        stroke-linejoin="round" fill="url(#star-0.8990893217310951)"
                                        xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E"
                                        class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.8990893217310951">
                                                <stop offset="1" stop-color="#FFCD4E"></stop>
                                                <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                                    ...
                                    <svgwidth="15" height="15" stroke-width="2" viewBox="0 0 24 24"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.529003036072093)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.529003036072093">
                                                <stop offset="1" stop-color="#FFCD4E"></stop>
                                                <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                                        <polygon
                                            ...
                                            stroke-linecap="round" stroke-linejoin="round"
                                            fill="url(#star-0.37987434886107563)" xmlns="http://www.w3.org/2000/svg"
                                            stroke="#FFCD4E" class="feather feather-star">
                                            <defs>
                                                <linearGradient id="star-0.37987434886107563">
                                                    <stop offset="1" stop-color="#FFCD4E"></stop>
                                                    <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                                </linearGradient>
                                            </defs>
                                            ...
                                            stroke-linecap="round" stroke-linejoin="round"
                                            fill="url(#star-0.0720493738234389)" xmlns="http://www.w3.org/2000/svg"
                                            stroke="#FFCD4E" class="feather feather-star">
                                            <defs>
                                                <linearGradient id="star-0.0720493738234389">
                                                    <stop offset="1" stop-color="#FFCD4E"></stop>
                                                    <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                                </linearGradient>
                                            </defs>
                                            ...
                                            stroke-linecap="round" stroke-linejoin="round"
                                            fill="url(#star-0.787869898135449)" xmlns="http://www.w3.org/2000/svg"
                                            stroke="#FFCD4E" class="feather feather-star">
                                            <defs>
                                                <linearGradient id="star-0.787869898135449">
                            ...
                            <li>
                                <div color="warn" value="3" readonly="" class="sc-e02ba328-0 gSOdBv"><svg width="15"
                                        height="15" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
                                        stroke-linejoin="round" fill="url(#star-0.8638150737486014)"
                                        xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E"
                                        class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.8638150737486014">
                                                <stop offset="1" stop-color="#FFCD4E"></stop>
                                                <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.5633304492854676)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.5633304492854676">
                                                <stop offset="1" stop-color="#FFCD4E"></stop>
                                                <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.9568718345276139)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.9568718345276139">
                                                <stop offset="1" stop-color="#FFCD4E"></stop>
                                                <stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.658438300853462)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.658438300853462">
                                                <stop offset="0" stop-color="#FFCD4E"></stop>
                                                <stop offset="0" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        fill="url(#star-0.5176025447350645)" xmlns="http://www.w3.org/2000/svg"
                                        stroke="#FFCD4E" class="feather feather-star">
                                        <defs>
                                            <linearGradient id="star-0.5176025447350645">
                                                <stop offset="0" stop-color="#FFCD4E"></stop>
                                                <stop offset="0" stop-color="#FFFFFF" stop-opacity="1"></stop>
                                            </linearGradient>
                                        </defs>
                        ...
                        <div class="border"></div>
                        <h6>Colors</h6>
                        <div class="colors d-flex gap-3 align-items-center ">
                        ...
                        <div class="section2">
                            <div class="flash-card-text">
                                ...
                                <div class="section3">
                                    ...
                                    <div class="icon2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="IconAdd" fill="red" width="20"
                                            height="20" viewBox="0 0 18 18" fill="red" class="injected-svg"
